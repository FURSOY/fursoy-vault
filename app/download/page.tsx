  ...
  return (
    <main className="legal-page download-page">
      ...
      <article>
        ...
        <section><h2>Code signing policy</h2><p>The initial v0.4.1 Windows companion is the project&apos;s one-time unsigned bootstrap release and may appear as <strong>Unknown publisher</strong> on Windows. It establishes the public release required for the SignPath Foundation application; later releases are intended to use the signing process below.</p><p>Free code signing provided by SignPath.io, certificate by SignPath Foundation. Every signing request requires manual approval, and only artifacts built from the public project repository are eligible.</p><ul className="role-list"><li>Committers and reviewers: <a href="https://github.com/FURSOY">FURSOY</a></li><li>Approvers: <a href="https://github.com/FURSOY">FURSOY</a></li></ul><a className="legal-link" href={`${repository}/blob/main/CODE_SIGNING_POLICY.md`}>Read the complete code signing policy</a></section>

...
export default function Home() {
  return (
    <main id="top">
      ...
      <footer><div className="wrap footer-main"><Brand /><div className="footer-links"><div><b>Project</b><a href="/download">Download</a><a href={github}>Source code</a><a href={releases}>Releases</a><a href={`${github}/issues`}>Issues</a></div><div><b>Trust</b><a href="/privacy">Privacy</a><a href={`${github}/blob/main/docs/THREAT_MODEL.md`}>Threat model</a><a href={`${github}/blob/main/CODE_SIGNING_POLICY.md`}>Code signing policy</a></div></div></div><div className="wrap footer-bottom"><span>© 2026 FURSOY. Licensed under GPL-3.0.</span><span>Free code signing provided by <a href="https://signpath.io" target="_blank" rel="noreferrer">SignPath.io</a>, certificate by <a href="https://signpath.org" target="_blank" rel="noreferrer">SignPath Foundation</a>.</span></div></footer>
    </main>
  );
}

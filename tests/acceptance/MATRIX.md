...
`run-windows.ps1` is the repeatable software gate. The final four rows require a real Windows
...
|---|---|---|
| Protocol/capability handshake | Automated | v5 ACK echoes request ID and required capabilities |

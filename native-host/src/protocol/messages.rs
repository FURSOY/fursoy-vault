...
pub struct Handshake {
    ...
    /// Random UUID persisted in chrome.storage.local. Chrome does not expose a stable profile
    /// identifier, so this is the privacy-preserving namespace boundary between browser profiles.
    pub profile_id: Uuid,
